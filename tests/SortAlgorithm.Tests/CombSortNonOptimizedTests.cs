...
public class CombSortNonOptimizedNonOptimizedTests
{
    [Theory]
    ...
    public void SortResultOrderTest(IInputSample<int> inputSample)
    {
        ...
        CombSortNonOptimized.Sort(array.AsSpan(), stats);
    ...
    public void GapSequenceTest(int n)
    {
        ...
        CombSortNonOptimized.Sort(data.AsSpan(), stats);
    ...
    public void TheoreticalValuesSortedTest(int n)
    {
        ...
        CombSortNonOptimized.Sort(sorted.AsSpan(), stats);
    ...
    public void TheoreticalValuesReversedTest(int n)
    {
        ...
        CombSortNonOptimized.Sort(reversed.AsSpan(), stats);
    ...
    public void TheoreticalValuesRandomTest(int n)
    {
        ...
        CombSortNonOptimized.Sort(random.AsSpan(), stats);
