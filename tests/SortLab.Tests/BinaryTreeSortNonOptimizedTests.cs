...
public class BinaryTreeSortNonOptimizedTests
{
    ...
    public void SortResultOrderTest(IInputSample<int> inputSample)
    {
        ...
        BinaryTreeSortNonOptimized.Sort(array.AsSpan(), stats);
    ...
    public void TheoreticalValuesSortedTest(int n)
    {
        ...
        BinaryTreeSortNonOptimized.Sort(sorted.AsSpan(), stats);
    ...
    public void TheoreticalValuesReversedTest(int n)
    {
        ...
        BinaryTreeSortNonOptimized.Sort(reversed.AsSpan(), stats);
    ...
    public void TheoreticalValuesRandomTest(int n)
    {
        ...
        BinaryTreeSortNonOptimized.Sort(random.AsSpan(), stats);
    ...
    public void TheoreticalValuesBalancedTest(int n)
    {
        ...
        BinaryTreeSortNonOptimized.Sort(balanced, stats);
