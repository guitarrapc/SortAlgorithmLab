...
public class QuickSortDualPivotInsertionTests
{
    ...
    public void SortResultOrderTest(IInputSample<int> inputSample)
    {
        ...
        QuickSortDualPivotInsertion.Sort(array.AsSpan());
    ...
    public void StatisticsTest(IInputSample<int> inputSample)
    {
        ...
        // Hybrid algorithm uses both swaps (QuickSort) and writes (InsertionSort)
    }
    ...
    public void StatisticsSortedTest(IInputSample<int> inputSample)
    {
        ...
        Assert.NotEqual(0UL, stats.IndexReadCount);
        Assert.NotEqual(0UL, stats.CompareCount);
        // For sorted data with InsertionSort hybrid, minimal writes expected
    }
