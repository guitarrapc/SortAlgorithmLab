...
public class QuickSortDualPivotWithBinaryInsertTests
{
    private ISort<int> sort;
    private string algorithm;
    private SortMethod method;

    public QuickSortDualPivotWithBinaryInsertTests()
    {
    ...
    [Theory]
    [InlineData(20)]  // Skip n=10 because it uses BinaryInsertSort internally
    [InlineData(50)]
    [InlineData(100)]
    public void TheoreticalValuesSortedTest(int n)
    {
        ...
        // For hybrid sorts, small arrays may use BinaryInsertSort
