...
public class MockAntiQuickSortData : IEnumerable<object[]>
{
    ...
    public MockAntiQuickSortData()
    {
        ...
        testData.Add([new InputSample<int>() { InputType = InputType.AntiQuickSort, Samples = GenerateMcIlroyPattern(100) }]);
        testData.Add([new InputSample<int>() { InputType = InputType.AntiQuickSort, Samples = GenerateMcIlroyPattern(1000) }]);
    }
    ...
    /// </summary>
    private static int[] GenerateMcIlroyPattern(int n)
    {
