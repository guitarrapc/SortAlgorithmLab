...
public class ShellSortCiura2001Tests
{
    ...
    public void RangeSortTest()
    {
        ...
        ShellSortCiura2001.Sort(array.AsSpan(), 2, 6, stats);
    ...
    public void RangeSortFullArrayTest()
    {
        ...
        ShellSortCiura2001.Sort(array.AsSpan(), 0, array.Length, stats);
    ...
    public void RangeSortSingleElementTest()
    {
        ...
        ShellSortCiura2001.Sort(array.AsSpan(), 2, 3, stats);
    ...
    public void RangeSortBeginningTest()
    {
        ...
        ShellSortCiura2001.Sort(array.AsSpan(), 0, 5, stats);
    ...
    public void RangeSortEndTest()
    {
        ...
        ShellSortCiura2001.Sort(array.AsSpan(), 5, 9, stats);
