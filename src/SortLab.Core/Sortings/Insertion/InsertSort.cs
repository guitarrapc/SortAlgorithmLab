...
|----------------- |------- |--------------:|-------------:|------------:|--------------:|--------------:|--------------:|----------:|
| InsertSort       | 100    |    104.067 us | 2,522.505 us | 138.2670 us |     33.200 us |     15.600 us |    263.400 us |     448 B |
| InsertSort       | 1000   |    142.833 us |    12.147 us |   0.6658 us |    143.000 us |    142.100 us |    143.400 us |     736 B |
| InsertSort       | 10000  | 12,186.533 us | 2,295.526 us | 125.8255 us | 12,181.500 us | 12,063.300 us | 12,314.800 us |     448 B |
...
public class InsertSort<T> : SortBase<T> where T : IComparable<T>
{
    ...
    private void SortCore(Span<T> span, int first, int last)
    {
        for (var i = first + 1; i < last; i++)
        {
            ...
            {
                var val = Index(ref span, j);
                Index(ref span, j + 1) = val;
                j--;
            }
