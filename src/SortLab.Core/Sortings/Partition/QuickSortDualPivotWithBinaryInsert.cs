...
/// <summary>
/// Dual-Pivot QuickSort に BinaryInsertSortを組み合わせたハイブリッドソート。
/// 小さな部分配列でBinaryInsertSortに切り替えることで、最高のパフォーマンスを目指す。
/// </summary>
/// <remarks>
/// stable  : no
...
public class QuickSortDualPivotWithBinaryInsert<T> : SortBase<T> where T : IComparable<T>
{
    public override SortMethod SortType => SortMethod.Partitioning;
    protected override string Name => nameof(QuickSortDualPivotWithBinaryInsert<T>);
