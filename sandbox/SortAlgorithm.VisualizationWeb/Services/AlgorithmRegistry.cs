...
public class AlgorithmRegistry
{
    ...
    private void RegisterAlgorithms()
    {
        ...
        Add("ShellSort (Knuth 1973)", "Insertion Sorts", "O(n^1.5)", MAX_SIZE, 1024, (arr, ctx) => ShellSortKnuth1973.Sort(arr.AsSpan(), ctx));
        Add("ShellSort (Sedgewick 1986)", "Insertion Sorts", "O(n^1.5)", MAX_SIZE, 1024, (arr, ctx) => ShellSortSedgewick1986.Sort(arr.AsSpan(), ctx));
        Add("ShellSort (Tokuda 1992)", "Insertion Sorts", "O(n^1.5)", MAX_SIZE, 1024, (arr, ctx) => ShellSortTokuda1992.Sort(arr.AsSpan(), ctx));
        Add("ShellSort (Ciura 2001)", "Insertion Sorts", "O(n^1.5)", MAX_SIZE, 1024, (arr, ctx) => ShellSortCiura2001.Sort(arr.AsSpan(), ctx));
        Add("ShellSort (Lee 2021)", "Insertion Sorts", "O(n^1.5)", MAX_SIZE, 1024, (arr, ctx) => ShellSortLee2021.Sort(arr.AsSpan(), ctx));
        ...
        Add("LSD RadixSort (b=4)", "Distribution Sorts", "O(nk)", MAX_SIZE, 4096, (arr, ctx) => RadixLSD4Sort.Sort(arr.AsSpan(), ctx));
        Add("LSD RadixSort (b=10)", "Distribution Sorts", "O(nk)", MAX_SIZE, 4096, (arr, ctx) => RadixLSD10Sort.Sort(arr.AsSpan(), ctx));
        Add("LSD RadixSort (b=256)", "Distribution Sorts", "O(nk)", MAX_SIZE, 4096, (arr, ctx) => RadixLSD256Sort.Sort(arr.AsSpan(), ctx));
        
        // Network Sorts - O(log²n) - 推奨2048
        Add("BitonicSort", "Network Sorts", "O(log²n)", MAX_SIZE, 2048, (arr, ctx) => BitonicSort.Sort(arr.AsSpan(), ctx));
        Add("BitonicSort (Parallel)", "Network Sorts", "O(log²n)", MAX_SIZE, 2048, (arr, ctx) => BitonicSortParallel.Sort(arr, ctx));
